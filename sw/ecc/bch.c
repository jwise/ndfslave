 ...
 * the structure.
 */
struct bch_control *bch_init_expert(int m, int t, unsigned int prim_poly)
{
	int err = 0;
	...
	static const unsigned int prim_poly_tab[] = {
		...
		/*0x402b*/0x4443, 0x8003,
	};

#if defined(CONFIG_BCH_CONST_PARAMS)
	if ((m != (CONFIG_BCH_CONST_M)) || (t != (CONFIG_BCH_CONST_T))) {
		fprintf(stderr, "bch encoder/decoder was configured to support "
...
struct bch_control *bch_init(int ndata, int necc)
{
	unsigned int m, t;
